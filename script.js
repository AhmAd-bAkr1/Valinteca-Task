...
containerCards.innerHTML += `<ul class ="menu"><div class ="emptyCart" >No Products</div></ul>
<div class ="containerShow" ></div>
`;
...
for (let i = 0; i < cards.length; i++) {
  ...
  // Add and Remove Product Btn in menu in Cart
  clone.children[2].classList.remove("add");
  clone.children[2].classList.add("remove");
  clone.children[3].classList.add("add");
  clone.children[3].classList.remove("remove");
// Remove Product in Menu From Cart
  clone.children[3].addEventListener("click", function (ele) {
    clone.remove();
    card.children[2].classList.remove("add");
...
// Qview Show Btn Prodct in Menu 
  clone.children[4].addEventListener("click", function (ele) {
    let elemnts = ele.currentTarget.parentElement;
    let clonee = elemnts.cloneNode(true);
    clonee.setAttribute("class", "Quick-show");
    containerShow.appendChild(clonee);
    ...
    clonee.children[2].addEventListener("click", function (ele) {
      ele.currentTarget.classList.add("remove");
      clonee.children[3].classList.add("add");
      clonee.children[3].classList.remove("remove");
      card.children[2].classList = clonee.children[2].classList;
      card.children[3].classList = clonee.children[3].classList;
      clone.setAttribute("class", "main-menu");
      menu.appendChild(clone);
      counter.textContent = menu.children.length - 1;
      if (counter.textContent == 0) {
    ...
    clonee.children[3].addEventListener("click", function (ele) {
      ele.currentTarget.classList.remove("add");
      ele.currentTarget.classList.add("remove");
      clonee.children[2].classList.remove("remove");
      clonee.children[2].classList.add("add");
      card.children[3].classList = clonee.children[3].classList;
      card.children[2].classList = clonee.children[2].classList;
      clone.remove();
      counter.textContent = menu.children.length - 1;
    ...
    clone.children[3].addEventListener("click", function (ele) {
      clonee.children[2].classList.remove("remove");
      clonee.children[2].classList.add("add");
      clonee.children[3].classList.add("remove");
      clonee.children[3].classList.remove("add");
      console.log("sks");
    });
  });
// Qview Show Btn Prodct
  card.children[4].addEventListener("click", function (ele) {
    ...
    // Add Btn Product To Menu in Qview Show Btn 
    clonee.children[2].addEventListener("click", function (ele) {
      ele.currentTarget.classList.add("remove");
      clonee.children[3].classList.add("add");
      clonee.children[3].classList.remove("remove");
    ...
    // Remove Btn Product From Menu in Qview Show Btn 
    clonee.children[3].addEventListener("click", function (ele) {
      ele.currentTarget.classList.remove("add");
      ele.currentTarget.classList.add("remove");
      clonee.children[2].classList.remove("remove");
